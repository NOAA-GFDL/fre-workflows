...
#make combine-statics output dir
#Path(COMBINE_STATICS_OUT).mkdir(parents=True,exist_ok=True)
...
def test_cdo_merge(monkeypatch):
#for sucess
...
def test_cdo_merge_output_content():
    ...
    with netCDF4.Dataset(outfile, 'r') as sf:
        ...
        assert cdo_call in history_str
