...
#PBS -N frepp.atw_atmos_ts_monthly_sfc.csh
...
#
#NAME
#   frepp.atw_atmos_ts_monthly_sfc.csh
#
#SYNOPSIS
...
#      $out_dir/atw_atmos_ts_monthly/sfc/
#
#AUTHOR
#   Andrew Wittenberg
#
...
set work_script = $ATW_FRE_ANALYSIS/atw/code/atmos_ts_monthly/sfc/csh/sfc.csh
...
set argu_test1 = "$shared_opt $pregrid_opt -n -r gpcp_v2p3 -T all,mam,son,jja,djf -A globe -N subpolar $y_subpolar plot_clim"
$work_script -o $out_dir $ref_opt \
   -m gfdl_model,$yr1,$yr2,$descriptor,$in_data_dir,$databegyr,$dataendyr,$datachunk,$staticfile \
   $argu_test1 || goto err


set argu_test2 = "$shared_opt $pregrid_opt -n -r era_interim -T all,mam,son,jja,djf -v t_surf -N globe $y_subpolar plot_clim"
$work_script -o $out_dir $ref_opt \
   -m gfdl_model,$yr1,$yr2,$descriptor,$in_data_dir,$databegyr,$dataendyr,$datachunk,$staticfile \
   $argu_test2 || goto err
